...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <textarea id="note_text" name="note_text" rows="3" cols="1" 
                                        class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-black outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" placeholder="Here's an idea for a note..." 
                                        require><?= $note['note_text'] ?? '' ?></textarea>
                                </div>
                            </div>
     ...
     <form id="delete-form" class="mt-6" method="POST" action="/note">
